...
public class TradeInVehicleDto {
    ...
    public TradeInVehicleDto(TradeInVehicle tradeInVehicle) {
        this.id = tradeInVehicle.getId();
        this.num_year = tradeInVehicle.getNum_year();
        this.str_brand = tradeInVehicle.getStr_brand();
        this.str_car_model = tradeInVehicle.getStr_car_model();
        this.dec_version = tradeInVehicle.getDec_version();
        this.str_color = tradeInVehicle.getStr_color();
        this.num_kilometers = tradeInVehicle.getNum_kilometers();
        this.dec_price = tradeInVehicle.getDec_price();
        this.dec_offer = tradeInVehicle.getDec_offer();
        this.dec_amount_offer = tradeInVehicle.getDec_amount_offer();
    }
}
