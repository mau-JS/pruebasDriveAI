...
public class VehicleOrderDetailDto {
    ...
    public VehicleOrderDetailDto(VehicleOrderDetail vehicleOrderDetail) {
        this.id = vehicleOrderDetail.getId();
        this.orderr_id = vehicleOrderDetail.getOrderr_id();
        this.str_automotive_group = vehicleOrderDetail.getStr_automotive_group();
        this.vehicle_id = vehicleOrderDetail.getVehicle_id();
    }
}
